import {ProductManager} from "../entities-model/features/product/manager/product-manager";
import {categories_data_array_, photos_data_array_, products_data_array_} from "./data/product-seed-data";
import {Product, ProductCategory} from "../entities-model/features/product/schemas/product-schema";
