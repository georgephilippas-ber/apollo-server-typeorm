...
export class ProductResolver extends Resolver
{
    ...
    getQueryResolver(): any
    {
        return {
            ...
            queryProductCategoryByCategoryName: (parent: any, args: any, context: any, info: any) => this.productManager.queryProductCategoryByCategoryName(args.partial_category_name_),
